...
export default Mixin.create({
  ...
  cpuUsage: computed('requested.cpu', 'allocatable.cpu', function() {
    const used  = parseSi(get(this, 'requested.cpu')) * 0.5 || 0;
    const total = parseSi(get(this, 'allocatable.cpu'));
  ...
  cpuReserved: computed('requested.cpu', 'allocatable.cpu', function() {
  ...
  memoryUsage: computed('requested.memory', 'allocatable.memory', function() {
    const used = parseSi(get(this, 'requested.memory')) * 0.4 || 0;
    const total = parseSi(get(this, 'allocatable.memory'));
  ...
  memoryReserved: computed('requested.memory', 'allocatable.memory', function() {
