...
const defaultStateMap = {
  'aborted':                    {icon: 'icon icon-alert',         color: 'text-warning'  },
  ...
  'building':                 {icon: 'icon icon-circle-o',      color: 'text-success'  },
  'created':                  {icon: 'icon icon-tag',           color: 'text-info'     },
  'creating':                 {icon: 'icon icon-tag',           color: 'text-info'     },
  'denied':                   {icon: 'icon icon-adjust',        color: 'text-error'    },
  ...
  'failed':                   {icon: 'icon icon-alert',         color: 'text-error'    },
  ...
  'success':                  {icon: 'icon icon-circle-o',      color: 'text-success'  },
  'skipped':                  {icon: 'icon icon-circle-o',      color: 'text-info'  },
  ...
  'untriggered':              {icon: 'icon icon-tag',           color: 'text-success'  },
