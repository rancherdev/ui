...
export default Component.extend({
  ...
  sharedEngineDidChange: observer('sharedEngine.value', function() {

    set(this, 'togglingSharedEngine', true);
    get(this, 'sharedEngine').save()
      .catch((err) => {

        get(this, 'growl').fromError('Error updating engine option', err);

      })
      .finally(() => {

        set(this, 'togglingSharedEngine', false);
  ...
  didReceiveAttrs() {
    ...
    const sharedEngine = get(this, 'settings').findBy('name', 'shared-engine');

    set(this, 'sharedEngine', sharedEngine);
    // set default oauth
